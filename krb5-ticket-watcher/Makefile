...
# Generated by qmake (1.07a) (Qt 3.3.4) on: Sun Oct 22 18:41:31 2006
...
install_binary: all 
	@$(CHK_DIR_EXISTS) "$(INSTALL_ROOT)$(DESTDIR)/usr/bin/" || $(MKDIR) "$(INSTALL_ROOT)$(DESTDIR)/usr/bin/"
	-$(INSTALL_FILE) "krb5-ticket-watcher" "$(INSTALL_ROOT)$(DESTDIR)/usr/bin/"
	-strip "$(INSTALL_ROOT)$(DESTDIR)/usr/bin/krb5-ticket-watcher"


uninstall_binary: 
	-$(DEL_FILE) -r "$(INSTALL_ROOT)$(DESTDIR)/usr/bin/krb5-ticket-watcher"
	-$(DEL_DIR) "$(INSTALL_ROOT)$(DESTDIR)/usr/bin/"


install: install_translations install_desktop install_documentation install_binary  

uninstall: uninstall_translations uninstall_desktop uninstall_documentation uninstall_binary  
