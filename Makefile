...
# Generated by qmake (1.07a) (Qt 3.3.5) on: Mon Oct 23 10:27:58 2006
...
LEX      = flex
YACC     = yacc
CFLAGS   = -pipe -O2 -march=i586 -mtune=i686 -fmessage-length=0 -Wall -D_FORTIFY_SOURCE=2 -g -fno-strict-aliasing -Wall -W -O2 -march=i586 -mtune=i686 -fmessage-length=0 -Wall -D_FORTIFY_SOURCE=2 -g -fno-strict-aliasing  -DDEBUG -DQT_NO_DEBUG -DQT_SHARED -DQT_TABLET_SUPPORT -DQT_THREAD_SUPPORT
CXXFLAGS = -pipe -O2 -march=i586 -mtune=i686 -fmessage-length=0 -Wall -D_FORTIFY_SOURCE=2 -g -fno-strict-aliasing -Wall -W -O2 -march=i586 -mtune=i686 -fmessage-length=0 -Wall -D_FORTIFY_SOURCE=2 -g -fno-strict-aliasing  -DDEBUG -DQT_NO_DEBUG -DQT_SHARED -DQT_TABLET_SUPPORT -DQT_THREAD_SUPPORT
LEXFLAGS = 
YACCFLAGS= -d
INCPATH  = -I/usr/lib/qt3/mkspecs/default -I. -I/usr/include -I$(QTDIR)/include
LINK     = g++
LFLAGS   = 
LIBS     = $(SUBLIBS) -L/usr/lib/ -L$(QTDIR)/lib/ -L/usr/X11R6/lib/ -lkrb5 -lcom_err -lqt-mt -lXext -lX11 -lm
AR       = ar cqs
RANLIB   = 
MOC      = $(QTDIR)/bin/moc
UIC      = $(QTDIR)/bin/uic
...
Makefile: krb5-ticket-watcher.pro  /usr/lib/qt3/mkspecs/default/qmake.conf /usr/lib/qt3/lib/libqt-mt.prl
...
clean: mocclean uiclean
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) src/*~ krb5-ticket-watcher-0.1.2.tar.bz2 krb5-ticket-watcher
	-$(DEL_FILE) *~ core *.core
...
dist-bzip2:
	@mkdir -p .tmp/krb5-ticket-watcher-0.1.2 && $(COPY_FILE) --parents $(SOURCES) $(HEADERS) $(FORMS) $(DIST) .tmp/krb5-ticket-watcher-0.1.2/ && $(COPY_FILE) --parents src/mainwidget.ui.h .tmp/krb5-ticket-watcher-0.1.2/ && ( cd `dirname .tmp/krb5-ticket-watcher-0.1.2` && $(TAR) krb5-ticket-watcher-0.1.2.tar krb5-ticket-watcher-0.1.2 && bzip2 krb5-ticket-watcher-0.1.2.tar ) && $(MOVE) `dirname .tmp/krb5-ticket-watcher-0.1.2`/krb5-ticket-watcher-0.1.2.tar.bz2 . && $(DEL_FILE) -r .tmp/krb5-ticket-watcher-0.1.2
...
TicketListItem.o: src/TicketListItem.cpp src/TicketListItem.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TicketListItem.o src/TicketListItem.cpp
...
install_documentation: all 
	...
	-$(INSTALL_FILE) "TODO" "$(INSTALL_ROOT)$(DESTDIR)/usr/share/doc/packages/krb5-ticket-watcher/"
...
uninstall_documentation: 
	...
	-$(DEL_FILE) -r "$(INSTALL_ROOT)$(DESTDIR)/usr/share/doc/packages/krb5-ticket-watcher/TODO"
