...
# Generated by qmake (1.07a) (Qt 3.3.4) on: Sat Oct 14 14:08:27 2006
...
dist-bzip2:
	@mkdir -p .tmp/krb5-ticket-watcher-0.1.0 && $(COPY_FILE) --parents $(SOURCES) $(HEADERS) $(FORMS) $(DIST) .tmp/krb5-ticket-watcher-0.1.0/ && $(COPY_FILE) --parents src/mainwidget.ui.h .tmp/krb5-ticket-watcher-0.1.0/ && ( cd `dirname .tmp/krb5-ticket-watcher-0.1.0` && $(TAR) krb5-ticket-watcher-0.1.0.tar krb5-ticket-watcher-0.1.0 && bzip2 krb5-ticket-watcher-0.1.0.tar ) && $(MOVE) `dirname .tmp/krb5-ticket-watcher-0.1.0`/krb5-ticket-watcher-0.1.0.tar.bz2 . && $(DEL_FILE) -r .tmp/krb5-ticket-watcher-0.1.0
